...
Tse_i = Ty(.3334, 0, .7839, pi/2);  % initial   configuration of the end-effector   wrt (space frame)
Tce_s = Ty( 0, 0, .25, pi);         % standoff  configuration of the end-effector   wrt (cube frame)
Tce_g = Ty( 0, 0,   0, pi);         % grasping  configuration of the end-effector   wrt (cube frame)
