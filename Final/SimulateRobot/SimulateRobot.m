...
%{
    NOTE:
    Simulate robot can only be run after running robotinfo.m and one of the trial files, best.m, overshoot.m, newtask.m.
    For use and testing, see test_SimulateRobot.
